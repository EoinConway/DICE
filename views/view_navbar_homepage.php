...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0">
            <!-- Jumbotron Nav with Hero Image -->
            <div class="jumbotron jumbotron-fluid text-white" style="background-image: url(imgs/hero_img_pexels.jpg);">
                <div class="container">
                    <!--Main Navigation-->
                    ...
                    <div class="text-center" style="font-family: 'Permanent Marker', cursive;" id="heroText">
                        <h1 class="display-1" id="hero-header">DICE</h1>
                        <p class="lead" id="hero-text">Drop In Casual Events</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container container-main">
                ...
                <h3 class='text-center mb-5'><?php echo $panelHead_1; ?></h3>
                <div class="row">
