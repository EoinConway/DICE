        ...
        <main class="flex-shrink-0">
            ...
            <div class="container container-main">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <h1 class="display-3 mb-3"><?php echo $panelHead_1; ?></h1>
                        <p class="lh-lg"><?php echo $panelContent_1; ?></p>
                    </div> 

                    <!--Right Hand Side (RHS)  content panel--> 
                    <div class="col-lg-6">
                        <img src="imgs/pexels-laptop.jpg" class="img-fluid" alt="person using laptop">
                    </div>
