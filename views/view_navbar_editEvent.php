                    ...
                    <main class="col-md-9 col-lg-10 ms-sm-auto px-md-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">
                                ...
                                if ($rs = $event->getFullEventDataByID($_GET['eventID'])) {
                                    $row = $rs->fetch_assoc();
                                    if ($admin->getRecordByEvent($_SESSION['userID'], $_GET['eventID'])) {
                                        include('forms/form_updateEvent.php');
                                    } else {
                                        $url = $_SERVER['PHP_SELF'] . '?pageID=home';
