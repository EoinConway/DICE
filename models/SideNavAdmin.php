...
//CLASS methods	
    ...
    //METHOD: setSideNav()
    public function setSideNav() {//set the menu items depending on the admins selected page ID
        ...
        if ($this->loggedin) {
            switch ($this->pageID) {
                    case "events":
                        ...
                        $this->sideNav .= '<li class="nav-item"><a class="nav-link" href="' . $_SERVER['PHP_SELF'] . '?pageID=createEvent">Create an Event</a></li>';
                    ...
                    case "createEvent":
                        $this->sideNav .= '<li class="nav-item"><a class="nav-link" href="' . $_SERVER['PHP_SELF'] . '?pageID=events">Dashboard</a></li>';
                        $this->sideNav .= '<li class="nav-item"><a class="nav-link" href="' . $_SERVER['PHP_SELF'] . '?pageID=yourEvents">Your Events</a></li>';
                        $this->sideNav .= '<li class="nav-item"><a class="nav-link active" href="' . $_SERVER['PHP_SELF'] . '?pageID=createEvent">Create an Event</a></li>';
                        $this->sideNav .= '<li class="nav-item"><a class="nav-link" href="' . $_SERVER['PHP_SELF'] . '?pageID=viewAllEvents">View All Events</a></li>';
                        break;
                    case "viewAllEvents":
                        $this->sideNav .= '<li class="nav-item"><a class="nav-link" href="' . $_SERVER['PHP_SELF'] . '?pageID=events">Dashboard</a></li>';
