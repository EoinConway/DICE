        ...
        //handlers for not logged in user
                    switch ($this->pageID) {
                        case "home":
                            ...
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=aboutUs">About Us</a></li></ul>';
                            $this->menuNav.='<ul class="navbar-nav ms-auto"><li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=login">Login</a></li>';
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=register">Register</a></li>';                       
                            break;
                        case "events":
                        ...
                        case "login":
                            ...
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=events">Events</a></li>';
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=aboutUs">About Us</a></li></ul>';
                            $this->menuNav.='<ul class="navbar-nav ms-auto"><li class="nav-item"><a class="nav-link active" href="'.$_SERVER['PHP_SELF'].'?pageID=login">Login</a></li>';
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=register">Register</a></li>';                       
                            break; 
                        case "register":
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=home">Home</a></li>';
                            ...
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=aboutUs">About Us</a></li></ul>';
                            $this->menuNav.='<ul class="navbar-nav ms-auto"><li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=login">Login</a></li>';
                            $this->menuNav.='<li class="nav-item"><a class="nav-link active" href="'.$_SERVER['PHP_SELF'].'?pageID=register">Register</a></li>';                       
                            break;
                        case "aboutUs":
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=home">Home</a></li>';
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=events">Events</a></li>';
                            $this->menuNav.='<li class="nav-item"><a class="nav-link active" href="'.$_SERVER['PHP_SELF'].'?pageID=aboutUs">About Us</a></li></ul>';
                            $this->menuNav.='<ul class="navbar-nav ms-auto"><li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=login">Login</a></li>';
                            $this->menuNav.='<li class="nav-item"><a class="nav-link" href="'.$_SERVER['PHP_SELF'].'?pageID=register">Register</a></li>';                       
                            break;
                        case "logout":
