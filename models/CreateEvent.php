...
//CLASS methods
    ...
    function __construct($user, $pageTitle, $pageHead, $database) {
        parent::__construct('CreateEvent', $user->getLoggedInState());
        $this->user = $user;
...
//end METHOD -   set the page heading
    ...
    public function setPanelHead_1() {//set the panel 1 heading
        $this->panelHead_1 = '<h3>Create an Event</h3>';
    }
        ...
        if ($this->loggedin) {
            if ($this->user->getUserType() === 'EVENTADMIN') { //An Admin is logged in
               if (isset($_POST['btnCreate'])){
                        ...
                        if($eventTable->addEvent($this->user->getUserID(),$_POST)){
                            $this->panelContent_2 .= 'New event added!';
                        }
                        else{
                            $this->panelContent_2 .= 'Event registration NOT successful';
                        }
                    }
            }
        } else {
